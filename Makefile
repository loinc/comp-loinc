...
examples/output: src/comp_loinc/schema/comp_loinc.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/comp_loinc/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
