    ...
    def load_description(self):
        ...
        for tpl in self.read_description().itertuples():
            ...
            snomed_node.set_property(
                type_=SnomedProperteis.fully_specified_name, value=term
            )
            snomed_node.set_property(
                type_=SnomedProperteis.concept_id, value=concept_id
            )
        ...
        for tpl in self.read_part_mapping().itertuples():
            ...
            if target_code:
                ...
                snomed_cocept.set_property(
                    type_=SnomedProperteis.concept_id, value=target_code
                )
                snomed_cocept.set_property(
                    type_=SnomedProperteis.fully_specified_name, value=target_display
                )
