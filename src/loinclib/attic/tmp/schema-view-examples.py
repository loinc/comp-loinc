...
schema.classes.get("LoincCodeClassIntersection").slot_usage.get(
    "has_component"
).annotations["owl"] = "Shahim Test"

slot_usage = schema.classes.get("LoincCodeClassIntersection").slot_usage.get(
    "has_component"
)
