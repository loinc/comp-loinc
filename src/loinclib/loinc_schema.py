...
class LoincTermSupplementaryEdges(LoincTermEdgeType):
  ...
  supplementary_METHOD_TYPE = LoincTermSupplementaryEdgesArgs(name="http://loinc.org/property/METHOD_TYP", order=112, abbr="SUP_MT")
  supplementary_PROPERTY = LoincTermSupplementaryEdgesArgs(name="http://loinc.org/property/PROPERTY", order=113, abbr="SUP_P")
  supplementary_SCALE_TYPE = LoincTermSupplementaryEdgesArgs(name="http://loinc.org/property/SCALE_TYP", order=114, abbr="SUP_ST")
