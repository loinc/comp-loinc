...
class Entity(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.parent_of = [v if isinstance(v, EntityId) else EntityId(v) for v in self.parent_of]
...
slots.entity__parent_of = Slot(uri=COMPLOINC.parent_of, name="entity__parent_of", curie=COMPLOINC.curie('parent_of'),
                   model_uri=LOINC.entity__parent_of, domain=None, range=Optional[Union[Union[str, EntityId], list[Union[str, EntityId]]]])
...
slots.loincTerm__primary_time_aspect = Slot(uri=LOINC_PROPERTY.TIME_ASPCT, name="loincTerm__primary_time_aspect", curie=LOINC_PROPERTY.curie('TIME_ASPCT'),
