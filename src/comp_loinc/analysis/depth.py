...
## Percentages, by data processing stage
Each value here is the percentage of the corresponding "1: raw_input" value.
...
def analyze_class_depth(
    ...
    counts_pivot = etl_counts_df_all.pivot_table(
    ...
    percents_pivot = etl_counts_df_all.pivot_table(
        index=["filter", "stage", "metric"],
        columns="terminology",
        values="percent",
        aggfunc="first",
