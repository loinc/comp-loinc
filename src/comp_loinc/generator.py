...
class Generator:
    ...
    def generate_loincs_list(self):
        ...
        self._outputs_schema[Generator.LOINCS_LIST] = linkml_runtime.SchemaView(
    ...
    def generate_loincs_primary_defs(self):
        ...
        self._outputs_schema[Generator.LOINCS_PRIMARY_DEFS] = linkml_runtime.SchemaView(
            self.schema_dir / 'code_schema.yaml')
    ...
    def generate_loincs_supplementary_defs(self):
        ...
        self._outputs_schema[Generator.LOINCS_SUPPLEMENTARY_DEFS] = linkml_runtime.SchemaView(
            self.schema_dir / 'code_schema.yaml')
    ...
    def generate_group_component_has_slash(self):
        ...
        has_slash = datamodel.LoincCodeClass(id=_loincify(Generator.GROUP_COMP_HAS_SLASH))
        has_slash.subClassOf = datamodel.LoincCodeClassId(_loincify(Generator.GROUPS))
        ...
        self._outputs_schema[Generator.GROUP_COMP_HAS_SLASH] = linkml_runtime.SchemaView(
            self.schema_dir / 'code_schema.yaml')
    ...
    def generate_parts_list(self):
        ...
        self._outputs_schema[Generator.PARTS_LIST] = linkml_runtime.SchemaView(
    ...
    def generate_parts_trees(self):
        ...
        for part_node_id in part_node_ids:
            ...
            part = datamodel.PartClass(id=_loincify(loinc_part_identifier))
        ...
        self._outputs_schema[Generator.PARTS_TREES] = linkml_runtime.SchemaView(
            self.schema_dir / 'part_schema.yaml')
    ...
    def generate_parts_group_chem_equivalences(self):
        ...
        group.subClassOf = datamodel.LoincCodeClassId(Generator.GROUPS)
        ...
        self._outputs_schema[Generator.PARTS_GROUP_CHEM_EQ] = code_view
    ...
    def _generate_mapping(self, namespace: ll.NameSpace):
        ...
        part_map: dict[str, datamodel.Thing] = {}
        ...
        for part_node_id in part_node_ids:
            ...
            for equivalent_target_node_id in [id for key, id in equivalent_target_node_ids.items() if
                ...
                loinc_part = part_map.setdefault(part_identifier, datamodel.Thing(NS.loinc.owl_url(part_identifier)))
                target: datamodel.Thing = datamodel.Thing(
        ...
        print('Finished looping through mappings')
        self._outputs[f'mapping-{namespace.node_id_prefix}-equivalence'] = part_map
        self._outputs_schema[f'mapping-{namespace.node_id_prefix}-equivalence'] = linkml_runtime.SchemaView(
            self.schema_dir / 'comp_loinc.yaml')
